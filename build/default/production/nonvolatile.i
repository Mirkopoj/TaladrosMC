...
void save_to_nonvolatile(){
 ...
 FLASH_WriteBlock(0x100, bloque);
}

int8_t read_from_nonvolatile(){
 if (FLASH_ReadWord(0x100)==DATOS_DEFAULT) {
  return 1;
 }

 BOTON1_MAX = FLASH_ReadWord(0x100 +1);
 BOTON1_MIN = FLASH_ReadWord(0x100 +2);
 BOTON2_MAX = FLASH_ReadWord(0x100 +3);
 BOTON2_MIN = FLASH_ReadWord(0x100 +4);
